...
//********************************************************************************************************************
// Defining the WuQuantizer class
//********************************************************************************************************************
...
//********************************************************************************************************************
// Implementation of the WuQuantizer class
//********************************************************************************************************************
...
private:
	...
	{
		mNormalizedInput.reserve(vcount);
...
public:
    ...
    uint32_t    mMaxQuantizeVertexCount{256};           // Maximum number of input vertices to consider (will be quantized not to exceed this amount)
};
...
public:
                            ...
                            bool doShrinkWrap) final
    {
        ...
        {
            VHACD::WuQuantizer *q = VHACD::WuQuantizer::create();
            uint32_t outputCount;
...
//        saveVoxelMesh(inputMesh,true,false);
    ...
    void computeConvexHull(void)
    {
        ...
        hp.mMaxQuantizeVertexCount = mParams.m_maximumVoxelPointsToConsider;
        hp.mMaxHullVertices = mParams.m_maximumVoxelPointsToConsider;
        uint32_t tcount = qh->computeConvexHull(hp);
        if ( tcount )
        {
...
public:
    ...
    */
                         ...
                         const uint32_t countTriangles)
    {
        ...
        printf("Computing bounds of input mesh.\n");
